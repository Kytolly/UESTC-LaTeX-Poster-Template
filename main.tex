...
\author{Rylan Schaeffer \inst{1} \and Ben Bitdiddle \inst{2} \and Lem E. Tweakit \inst{2}}

\institute[shortinst]{\inst{1} Department of Computer Science}
\institute[shortinst]{\inst{1} Computer Science, Stanford \samelineand \inst{2} Another Institute}
...
\addtobeamertemplate{headline}{}
{
    ...
    %   {\includegraphics[height=5.0cm]{stanford_logos/Stanford-CS.png}}; % uc-logo-white.eps
      ...
      {\includegraphics[height=7.0cm]{figures/校徽反白.png}};
    \end{tikzpicture}
}
